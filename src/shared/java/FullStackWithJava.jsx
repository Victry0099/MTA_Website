...
import { coursesFSDJavaData } from "../../data/courseModule";
import { Link } from "react-router-dom";

function FullStackWithJava() {
  return (
    <>
      <Coursebreadcrumb
        coursename="Full Stack with Java"
        coursediscription="Full stack development with Java is one-of-a-kind course for developers who want to become an expert in full stack development."
        star="4.7"
        review="7 Reviews"
        ...
        <div className="details-left lg:w-4/6 w-full pl-8 pt-8">
          <div className="about-course">
            ...
            <p className="pr-20 mb-6">
              Full stack development with Java is one-of-a-kind course for
              ...
              web development and Java programming along will its application in
              real world. MTA India has a mission to bring out the best full
              stack developers by providing top-notched training from expert
              professionals.
            </p>

            <p className="pr-20 mb-6">
              By enrolling on full stack development with Java training program,
              the trainees will get 100% placement opportunities in top MNCs in
              India. The course structure, the modules, the study materials can
              help a normal web developer to become a successful full stack
              developer. Expert trainers at MTA India will leave no stone
              unturned to guide trainees in every stage of this training
              program.
            </p>
      ...
      <CoursesModule courses={coursesFSDJavaData} />
    </>
  );
}

export default FullStackWithJava;
