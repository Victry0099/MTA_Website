              ...
              >
                <div className="w-full flex justify-center items-center bg-green-200">
                  <img
                    src={item.image}
                    alt={item.title}
                    className="object-center w-full h-52 sm:h-40 lg:h-52  border-b-2 border-b-red-100"
                  />
                </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center justify-center py-2 pe-4 text-homepage-button-color2 rounded-sm">
                    <Button
